...
CDN_SIGNING_KEY_NAME = os.environ.get(
    "CDN_SIGNING_KEY_NAME"
)  # "my-cdn-signing-key" # The name you gave in the console
CDN_SIGNING_SECRET = os.environ.get("CDN_SIGNING_SECRET")  # The secret you copied


# --- Function to generate CDN Signed URL ---
def generate_cdn_signed_url(
    base_url: str, object_path: str, expiration_time: timedelta
) -> str:
    ...
    try:
        ...
        expiration_timestamp = int(
            time.time() + expiration_time.total_seconds()
        )  # int((expiration_time - epoch).total_seconds()) #
