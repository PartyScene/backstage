...
class NotificationManager:
    ...
    async def send_otp_notification(self, 
                               user_id: str, 
                               otp: str, 
                               workflow_id: str = 'one-time-password'):
        """
    ...
    async def recent_login_notification(self, 
                               user_id: str,
                               payload: Dict,
    ...
    async def send_friend_request_notification(self, 
                                         sender: str,
                                         recipient_id: str,
                                         workflow_id: str = 'friend-request'):
        """
    ...
    async def send_event_invitation(self, 
                               event_id: str, 
    ...
    async def send_livestream_notification(self, 
                                     event_id: str, 
    ...
    def send_post_interaction_notification(self, 
                                           post_id: str, 
                                           actor_id: str, 
                                           recipient_id: str, 
